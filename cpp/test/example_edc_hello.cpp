...
void example_external_decision_component_hello_feature1(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
...
void example_external_decision_component_hello_feature2(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
        EDCHelloOptions().request_dynamic_registration()
...
void example_external_decision_component_hello_feature3(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
        EDCHelloOptions().request_dynamic_registration()
                         .request_profile_reuse()
...
void example_external_decision_component_hello_feature4(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
...
void example_external_decision_component_hello_feature5(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
...
void example_external_decision_component_hello_feature6(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
...
void example_external_decision_component_hello_no_storage_sharing(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
...
void example_external_decision_component_hello_job_alloc_validation_strategy(batprotocol::MessageBuilder & builder)
{
    builder.add_external_decision_component_hello("cpp-unit-test", "0.1.0", "unknown",
